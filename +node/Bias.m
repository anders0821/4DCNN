classdef Bias < handle
    ...
    methods
        ...
        function [] = ff(this)
            ...
            %tic;
            [H, W, D, T, C, N] = size(this.pI.O);
            this.O = this.pI.O + repmat(permute(this.P, [3 4 5 6 1 2]), [H W D T 1 N]);
            %toc;
        end
        ...
        function [] = bp(this)
            ...
            % 计算参数的梯度
            this.gradP = sum(sum(sum(sum(sum(this.gradO, 6), 4), 3), 2), 1);
            this.gradP = permute(this.gradP, [5 6 1 2 3 4]);
